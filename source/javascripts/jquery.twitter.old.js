(function($) {
  ...
  $.fn.tweet = function(o){
    ...
    return this.each(function(){
      ...
      query += '&q=';
      var url = 'http://search.twitter.com/search.json?&'+query+'&rpp='+s.count+'&callback=?&lang='+lang;
      ...
      $.getJSON(url, function(data){
        ...
        $.each(data.results, function(i,item){
          ...
          var user = '<a class="tweet_user" href="http://twitter.com/'+ item.from_user+'">@'+item.from_user+'</a> ';
          ...
          list.append('<li>' + avatar + user + join + text + '<br/><span class="meta">about ' + date + '</span></li>');
